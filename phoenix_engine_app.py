...
if page == "🌎 **Global Command Center**":
    ...
    with tab_langchain:
        ...
        report_text = st.text_area("Paste Structured Report Data Here:", height=200, value='{"study_id": "VX-CF-MOD-01", "qc_run_date": "2024-05-21", ...}');
        if st.button("🤖 Generate Summary with LangChain PoC"):
            with st.spinner("Simulating call to LangChain API..."):
                ...
                st.info(" **Study VX-CF-MOD-01 QC Summary:**\n\nThe quality control analysis...for **lot LOT-2024-AAAA**, which failed...the failing reagent lot has been flagged and quarantined.")
    ...
    with tab_r:
        ...
        if RPY2_INSTALLED:
            ...
            st.error("**Deployment Note:** `rpy2` is not installed in this environment... The image below is a static representation of the expected output.")
